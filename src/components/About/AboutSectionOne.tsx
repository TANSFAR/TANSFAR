              ...
              >
                <div className="mx-[-12px] flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="Instant Conversion" />
                    <List text="Wide Currency Support" />
                    <List text="Local Payout Options" />
                  </div>

                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="Low Fees" />
                    <List text="B2B Payments" />
                    <List text="Freelancer and Contractor Payments" />
                  </div>
                </div>
              </div>
            </div>
